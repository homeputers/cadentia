...
const explanationCodeRegistryEntries = [
  ...
  entry("SCORE_COMPONENT_TEAM_SUITABILITY", "team_suitability", "item.score_component_team_suitability", ["item", "selected_song"], ["info"], ["worship_leader", "admin"], ["score"]),
  entry("TEAM_REQUIRED_INSTRUMENT_COVERAGE", "team_suitability", "team.required_instrument_coverage", ["item", "selected_song"], ["info", "warning", "blocked"], ["worship_leader", "admin"], ["status", "targetCode", "requiredCount", "actualCount", "minimumSkillRank"]),
  entry("TEAM_OPTIONAL_INSTRUMENT_FIT", "team_suitability", "team.optional_instrument_fit", ["item", "selected_song"], ["info", "warning"], ["worship_leader", "admin"], ["status", "targetCode", "requiredCount", "actualCount", "minimumSkillRank"]),
  entry("TEAM_VOCAL_CONFIGURATION", "team_suitability", "team.vocal_configuration", ["item", "selected_song"], ["info", "warning", "blocked"], ["worship_leader", "admin"], ["status", "vocalConfiguration", "requiredCount", "actualCount"]),
  entry("TEAM_LEAD_VOCAL_RANGE_FIT", "team_suitability", "team.lead_vocal_range_fit", ["item", "selected_song"], ["info", "warning", "blocked"], ["worship_leader", "admin"], ["status", "rangeRequirement", "fitCount"]),
  entry("TEAM_SKILL_LEVEL_FLOOR", "team_suitability", "team.skill_level_floor", ["item", "selected_song"], ["info", "warning", "blocked"], ["worship_leader", "admin"], ["status", "targetCode", "requiredCount", "actualCount", "minimumSkillRank"]),
  entry("TEAM_AVAILABILITY_STATUS", "team_suitability", "team.availability_status", ["item", "selected_song"], ["info", "warning", "blocked"], ["worship_leader", "admin"], ["status", "unavailableCount", "activeAssignmentCount"]),
  entry("TEAM_ASSIGNMENT_STATUS", "team_suitability", "team.assignment_status", ["item", "selected_song"], ["info", "warning"], ["worship_leader", "admin"], ["status", "assignedCount", "activeAssignmentCount"]),
  entry("TEAM_READINESS_WARNING", "team_suitability", "team.readiness_warning", ["item", "selected_song", "warning"], ["info", "warning"], ["worship_leader", "admin"], ["status", "warningCount"]),
  ...
  entry("TEMPO_TRADEOFF_ACCEPTED", "tradeoffs", "transition.tempo_tradeoff_accepted", ["transition", "adjacent_transition"], ["warning"], ["public", "worship_leader", "admin"], ["fromBpm", "toBpm", "maxJumpBpm", "jumpBpm", "penalty"]),
  entry("ARRANGEMENT_COMPATIBLE", "transitions", "transition.arrangement_compatibility", ["transition", "adjacent_transition"], ["info", "warning"], ["worship_leader", "admin"], ["compatible", "parserConfidence"]),
  entry("TRANSITION_METADATA_MISSING", "warnings", "transition.metadata_missing", ["transition", "adjacent_transition", "warning"], ["warning"], ["worship_leader", "admin"], ["missingFields"]),
