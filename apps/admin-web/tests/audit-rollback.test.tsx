...
describe('audit history and rollback workflows', () => {
    it('serializes supported audit filters and deep links', () => {
        const filters = parseAuditFilters('?entityType=SONG&actor=a1&from=2026-01-01&importBatchId=b1&candidateId=c1&songId=s1&arrangementId=ar1&moderationFlagId=f1&rollbackRequestId=r1&event=e1');
        expect(buildAuditHistoryPath(filters)).toContain('entityType=SONG');
        expect(buildAuditHistoryPath(filters)).toContain('rollbackRequestId=r1');
    });
