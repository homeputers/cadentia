    ...
    private static List<Entry> registryEntries() {
        return List.of(
            ...
            itemInternal(
                    ...
                    Set.of("status", "targetCode", "requiredCount", "actualCount", "minimumSkillRank"),
                    Severity.INFO,
                    Severity.WARNING,
                    Severity.BLOCKED),
            itemInternal(
            ...
            itemInternal(
                    ...
                    "team_suitability",
                    "team.vocal_configuration",
                    Set.of("status", "vocalConfiguration", "requiredCount", "actualCount"),
                    Severity.INFO,
                    Severity.WARNING,
                    Severity.BLOCKED),
            itemInternal(
                    ...
                    Set.of("status", "rangeRequirement", "fitCount"),
                    Severity.INFO,
                    Severity.WARNING,
                    Severity.BLOCKED),
            itemInternal(
            ...
            itemInternal(
                    ...
                    Set.of("status", "unavailableCount", "activeAssignmentCount"),
                    Severity.INFO,
                    Severity.WARNING,
                    Severity.BLOCKED),
            itemInternal(
                    ...
                    Set.of("status", "assignedCount", "activeAssignmentCount"),
                    Severity.INFO,
                    Severity.WARNING),
            itemInternal(
                    "TEAM_READINESS_WARNING",
                    "team_suitability",
                    "team.readiness_warning",
                    Set.of("status", "warningCount"),
                    Severity.INFO,
                    Severity.WARNING),
            transition(
                    "SAME_KEY_TRANSITION",
